          ...
          <div class="team-container container">
            ...
            <div class="row">
              <div class="col-sm-6">
                <div class="team-member">
                  <figure>
                    <img src="assets/images/team/jenny.jpg" alt="<?=L::contact_members_jenny_name?>">
                    <figcaption>
                      <p class="member-name"><?=L::contact_members_jenny_name?></p>
                      <p class="designation">
                        <?=L::contact_members_jenny_role?><br>
                        <i class="fa fa-phone"></i>&nbsp;&nbsp;<a href="tel:+359879203341">+359879203341</a>
                      </p><!-- /.designation -->
                    </figcaption>
                  </figure>
                  <div class="social-btn-container">
                    <div class="team-socail-btn">
                      <span class="social-btn-box phone-btn-container">
                        <a href="tel:+359879203341" class="phone-btn">
                          <i class="fa fa-phone"></i>
                        </a><!-- /.phone-btn -->
                      </span><!-- /.social-btn-box -->

                      <span class="social-btn-box twitter-btn-container">
                        <a href="https://twitter.com/jenny_pavlova" class="twitter-btn">
                          <i class="fa fa-twitter"></i>
                        </a><!-- /.twitter-btn -->
                      </span><!-- /.social-btn-box -->

                      <span class="social-btn-box linkedin-btn-container">
                        <a href="https://bg.linkedin.com/in/jenny-pavlova-a52a1498" class="linkedin-btn">
                          <i class="fa fa-linkedin"></i>
                        </a><!-- /.linkedin-btn -->
                      </span><!-- /.social-btn-box -->

                      <span class="social-btn-box email-btn-container">
                        <a href="mailto:jenny@igem-bulgaria.com" class="email-btn">
                          <i class="fa fa-envelope"></i>
                        </a><!-- /.email-btn -->
                      </span><!-- /.social-btn-box -->
                    </div><!-- /.team-socail-btn -->
              ...
              <div class="col-sm-6">
                <div class="team-member">
                  <figure>
                    <img src="assets/images/team/angel.jpg" alt="<?=L::contact_members_angel_name?>">
                    <figcaption>
                      <p class="member-name"><?=L::contact_members_angel_name?></p>
                      <p class="designation">
                        <?=L::contact_members_angel_role?><br>
                        <i class="fa fa-phone"></i>&nbsp;&nbsp;<a href="tel:+359895806004">+359895806004</a>
                      </p><!-- /.designation -->
                    </figcaption>
                  </figure>
                  <div class="social-btn-container">
                    <div class="team-socail-btn">
                      <span class="social-btn-box phone-btn-container">
                        <a href="tel:+359895806004" class="phone-btn">
                          <i class="fa fa-phone"></i>
                        </a><!-- /.phone-btn -->
                      </span><!-- /.social-btn-box -->
                      ...
                      <span class="social-btn-box email-btn-container">
                        <a href="mailto:angel@igem-bulgaria.com" class="email-btn">
                          <i class="fa fa-envelope"></i>
                        </a><!-- /.email-btn -->
                      </span><!-- /.social-btn-box -->
                    </div><!-- /.team-socail-btn -->
